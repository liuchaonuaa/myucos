...
"}"));
        ...
        loadButton->setGeometry(QRect(279, 129, 81, 31));
        QFont font4;
        ...
        viewButton->setGeometry(QRect(170, 130, 61, 30));
        viewButton->setFont(font4);
        eraseButton = new QPushButton(binBox);
        eraseButton->setObjectName(QStringLiteral("eraseButton"));
        eraseButton->setGeometry(QRect(40, 130, 81, 31));

        gridLayout_3->addWidget(binBox, 0, 0, 1, 1);
    ...
    {
        Widget->setWindowTitle(QApplication::translate("Widget", "\346\261\237\350\213\217\346\231\266\346\265\251\342\200\224\342\200\224\345\255\227\345\272\223\347\203\247\345\206\231", 0));
        ...
        loadButton->setText(QApplication::translate("Widget", "\345\255\227\345\272\223\344\270\213\350\275\275", 0));
        viewButton->setText(QApplication::translate("Widget", "\346\237\245\347\234\213Bin", 0));
        eraseButton->setText(QApplication::translate("Widget", "\345\255\227\345\272\223\346\223\246\345\206\231", 0));
