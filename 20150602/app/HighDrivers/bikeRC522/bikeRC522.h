#ifndef __BIKERC522_H
#define __BIKERC522_H	
...
#define BIKERC522_NSS_1  	GPIOA->BSRR = (1<<4)
#define BIKERC522_NSS_0  	GPIOA->BRR = (1<<4)

#define BIKERC522_RST_1  	GPIOC->BSRR = (1<<6)
#define BIKERC522_RST_0  	GPIOC->BRR = (1<<6)
