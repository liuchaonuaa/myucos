#ifndef __USERRC522_H
#define __USERRC522_H	
...
#define USERRC522_NSS_1  	GPIOB->BSRR = (1<<12)
#define USERRC522_NSS_0  	GPIOB->BRR = (1<<12)

#define USERRC522_RST_1  	GPIOC->BSRR = (1<<7)
#define USERRC522_RST_0  	GPIOC->BRR = (1<<7)
