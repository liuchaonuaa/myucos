...
"}"));
        ...
        viewButton->setGeometry(QRect(230, 130, 61, 30));
        viewButton->setFont(font4);
        programButton = new QPushButton(binBox);
        programButton->setObjectName(QStringLiteral("programButton"));
        programButton->setGeometry(QRect(110, 130, 41, 31));
        startButton = new QPushButton(binBox);
        startButton->setObjectName(QStringLiteral("startButton"));
        startButton->setGeometry(QRect(10, 130, 41, 31));
        resetButton = new QPushButton(binBox);
        resetButton->setObjectName(QStringLiteral("resetButton"));
        resetButton->setGeometry(QRect(160, 130, 41, 31));
        eraseButton = new QPushButton(binBox);
        eraseButton->setObjectName(QStringLiteral("eraseButton"));
        eraseButton->setGeometry(QRect(60, 130, 41, 31));
    ...
    {
        Widget->setWindowTitle(QApplication::translate("Widget", "\346\261\237\350\213\217\346\231\266\346\265\251\342\200\224\342\200\224\345\234\250\347\272\277\345\215\207\347\272\247", 0));
        ...
        programButton->setText(QApplication::translate("Widget", "\347\274\226\347\250\213", 0));
        startButton->setText(QApplication::translate("Widget", "\345\220\257\345\212\250", 0));
        resetButton->setText(QApplication::translate("Widget", "\345\244\215\344\275\215", 0));
