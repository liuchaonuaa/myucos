...
void Widget::readData()
{
    ...
    if (usart_temp == "Erase")
    {
        ...
        ui->loadTextEdit->insertPlainText(tr("字库擦写完成"));
        usart_temp.clear();
    }
}
...
void Widget::transmitDataFun(int cnt)   // 发送文件
{
    ...
    //  0x5a 0xa1  index_L index_H data_len_L  data_len_H  data(no more than 1K)   reserved[2]  CRC
